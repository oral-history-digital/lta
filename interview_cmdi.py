...
def change_media_session_bundle(root_elem, num_bundles):
    ...
    for index in range(1, num_bundles + 1):
        ...
        media_type = ET.SubElement(media_file, 'Type')
        media_type.text = 'video' # TODO: Do not hardcode this anymore.
        ...
        annotation_format_inner = ET.SubElement(annotation_format_outer,
            'AnnotationFormat')
        annotation_format_inner.text = 'application/vnd.oasis.opendocument.spreadsheet'
